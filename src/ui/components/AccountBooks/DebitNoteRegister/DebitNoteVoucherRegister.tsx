...
import { PurchaseInvoiceBreakupReport } from '../../../../apis/reports/purchase_invoice'

const DebitNoteVoucherRegister = ({ homeHookData, globalData }: any) => {
    ...
    const fetchVoucherList = async () => {
        try {
            ...
            ? await window.electron.PurchaseInvoiceBreakupReport({
                filters: {
                ...
                token
            }):await PurchaseInvoiceBreakupReport({
                filters: {
                    from_date: voucherRegisterMonthDate?.start_date,
                    to_date: voucherRegisterMonthDate?.end_date,
                    company: "8848 Digital LLP",
        ...
        >
            ...
            <PageHeader ragisterName='Voucher Register' company={companyName} />
                <VoucherRegister
                    ...
                    type='debit_note_voucher_register'
                />
                <BottomNavbar />
            </div>
            <Sidebar
...
export default DebitNoteVoucherRegister
