...
const Login = ({ onLoginSuccess }: any) => {
    ...
    return (
        <div
            className="d-flex justify-content-center align-items-center vh-100 w-100 gray_bg">
            <div className="text-center">

                {/* <div className="card p-4 shadow-sm" style={{ width: "350px" }}> */}
                <form
                    className="card pt-5 pb-5 ps-4 pe-4 shadow-sm login_form"
                    style={{ width: "350px" }}
                ...
                >
                    ...
                    <div className="mb-3 input-group">
                        <span className="input-group-text border-0 light_bg"><FaLock /></span>
                        <input
                        ...
                        <button
                            type="button"
                            className="btn border-0 light_bg password_btn"
                    ...
                    <button
                        type="submit"
                        className="btn btn-primary w-100 mt-2 border-0 text-capitalize"
                        disabled={loading}
                    >
