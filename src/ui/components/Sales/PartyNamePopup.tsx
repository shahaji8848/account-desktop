      ...
      <div className="popup-body">
        <div className="d-flex align-items-center w-100">
          <div className="salesNo d-flex align-items-center justify-content-between" style={{ width: '33%' }}>
            <label className="ps-1 pe-3"><b>Party A/C Name</b></label>
            <p>: </p>
          </div>
          <input
            name="party_name"
        ...
        <div className="d-flex align-items-center w-100 pt-1">
          <div className="salesNo d-flex align-items-center justify-content-between" style={{ width: '33%' }}>
            <label className="ps-1 pe-3"><b>Billing Address</b></label>
            <p>: </p>
          </div>
          <input
        ...
        <div className="d-flex align-items-center w-100 pt-5">
          <div className="salesNo d-flex align-items-center justify-content-between" style={{ width: '33%' }}>
            <label className="ps-1 pe-3"><b>Shipping Address</b></label>
            <p>: </p>
          </div>
          <input
