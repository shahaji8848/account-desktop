      ...
      <div className="main-body" style={{ width: '86%' }}>
        {!isModalOpen ? (
          ...
          >
            ...
            <p style={{ width: '5%', cursor: 'pointer' }} className="text-end cursor-pointer">
              X
            </p>
          </div>
        ) : (
          ...
          >
            ...
            <p onClick={() => setIsModalOpen(false)} style={{ width: '5%', cursor: 'pointer' }} className="text-end cursor-pointer">
              X
            </p>
          </div>
        )}
        ...
        <TallyUI
          ...
          setShowBankingMenuList={setShowBankingMenuList}
          showBankingMenuList={showBankingMenuList}
        />
      </div>
      {!isModalOpen ? (
        <Sidebar dateRef={homeHookData.dateRef} openCompanyDropdown={homeHookData.openCompanyDropdown} sideBarData={homeSideBarData} />
      ) : (
        <Sidebar dateRef={homeHookData.dateRef} openCompanyDropdown={homeHookData.openCompanyDropdown} />
      )}
    </div>
  );
};
