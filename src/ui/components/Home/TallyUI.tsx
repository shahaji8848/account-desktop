  ...
  return (
    <div className="container-fluid home_page" style={{ height: "100%" }} onKeyDown={handlekeyfunctions}>
      <div className="row" style={{ height: "100%" }}>
        ...
        {/* Right Section */}
        {(!moreReportList && !accountBooksList) && <HomeMenuList menuItemsRef={menuItemsRef} selectedIndex={selectedIndex} handleKeyDown={handleKeyDown} handleClick={handleClick}/>}
        {(moreReportList && !accountBooksList) && <MoreReportMenuList menuItemsRef={menuItemsRef} selectedIndex={selectedIndex} handleKeyDown={handleKeyDown} handleClick={handleClick}/>}
        {(accountBooksList && !moreReportList) && <AccountBooksMenuList menuItemsRef={menuItemsRef} selectedIndex={selectedIndex} handleKeyDown={handleKeyDown} handleClick={handleClick}/>}
